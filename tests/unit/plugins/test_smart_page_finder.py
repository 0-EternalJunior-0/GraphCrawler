...
class TestSmartPageFinderPlugin:
    ...
    def test_plugin_creation_with_config(self):
        ...
        assert plugin.strict_mode == True
    ...
    def test_keyword_analysis(self, mock_context):
        ...
        assert 'python' in result['reason'].lower() or 'developer' in result['reason'].lower()
...
class TestSmartFinderNode:
    ...
    def test_create_node_class(self):
        ...
        from graph_crawler.extensions.plugins.node.smart_page_finder import create_smart_finder_node_class
    ...
    def test_smart_finder_node_import(self):
        ...
        from graph_crawler.extensions.plugins.node import SmartFinderNode
