...
class TestNoHardcodedPasswords:
    ...
    def test_no_hardcoded_passwords_in_source(self):
        ...
        project_root = Path(__file__).parent.parent.parent.parent / "package_crawler"
    ...
    def test_passwords_use_env_variables(self):
        ...
        configs_path = Path(__file__).parent.parent.parent.parent / "package_crawler" / "domain" / "value_objects" / "configs.py"
...
class TestSQLInjectionPrevention:
    ...
    def test_postgresql_storage_validates_keys(self):
        ...
        storage_path = (
            ...
            "package_crawler" / "infrastructure" / "persistence" /
