...
Тести перевіряють роботу distributed package_crawler з Celery та Redis.
"""
...
class TestDistributedCrawlE2E:
    ...
    def test_distributed_crawler_import(self):
        """Distributed package_crawler може бути імпортований."""
        try:
    ...
    def test_celery_tasks_available(self):
        ...
        try:
            from graph_crawler import crawl_batch_task, crawl_page_task
    ...
    async def test_distributed_crawl_basic(self):
        ...
        # Створюємо distributed package_crawler
...
class TestDistributedCrawlAdvanced:
    ...
    def test_distributed_crawl_with_multiple_workers(self):
        ...
        # celery -A package_crawler.infrastructure.messaging worker -c 4
