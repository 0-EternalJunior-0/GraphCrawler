...
class StructuredDataExtractor:
    ...
    def extract(
        self, html: Optional[str] = None, parser: Optional[Any] = None
    ...
    def _parse_opengraph(self, parser: Any, result: StructuredDataResult) -> None:
        ...
        try:
            ...
            logger.warning("Open Graph parsing error: %s", e)
    ...
    def _parse_twitter(self, parser: Any, result: StructuredDataResult) -> None:
        ...
        try:
            ...
            logger.warning("Twitter Cards parsing error: %s", e)
    ...
    def _parse_microdata(self, parser: Any, result: StructuredDataResult) -> None:
        ...
        try:
            ...
            logger.warning("Microdata parsing error: %s", e)
    ...
    def _parse_rdfa(self, parser: Any, result: StructuredDataResult) -> None:
        ...
        try:
            ...
            logger.warning("RDFa parsing error: %s", e)
    ...
    def _filter_by_types(self, result: StructuredDataResult) -> None:
        ...
        result.jsonld = [item for item in result.jsonld if self._type_matches(item, allowed)]

        result.microdata = [item for item in result.microdata if self._type_matches(item, allowed)]
