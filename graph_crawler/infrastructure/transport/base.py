...
class BaseDriver(EventPublisherMixin, ABC, IDriver):
    ...
    def __init__(
        ...
        # SSRF Protection: дозволити внутрішні адреси для тестування
        self._allow_internal = self.config.get("allow_internal_urls", False)
    ...
    def _validate_url_security(self, url: str) -> None:
        ...
        """
        validate_url_security(url, allow_internal=self._allow_internal)
