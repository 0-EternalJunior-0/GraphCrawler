...
Знаходиться в shared layer для доступу з:
...
class NodeDTO(BaseModel):
    ...
    content_type: str = Field(
        default="unknown", description="Тип контенту сторінки (html, json, image, etc.)"
    )
